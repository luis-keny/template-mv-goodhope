  ...
  <div class="space-y-6">
    ...
    <Card>
      <CardHeader>
        ...
        <CardDescription>Props del componente ButtonGroup</CardDescription>
      </CardHeader>
      <CardContent class="space-y-6">
        <div>
          <p class="text-sm font-medium mb-2">ButtonGroup</p>
          <Table>
            <TableHeader>
              <TableRow>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell>La orientación del grupo de botones.</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </div>
